    ...
    static partial class GdsDefs
    {
        ...
        public static string ProductName
        {
            get
            {
                if (s_productName == null)
                {
                    ...
                    var assemblyTitle = attrs[0] as AssemblyTitleAttribute;
        ...
        public static string Version
        {
            get
            {
                ...
                var asmVer = attrs[0] as AssemblyInformationalVersionAttribute;
        ...
        public static ProtectedString PsEmptyEx
        {
            get
            {
                if (s_emptyEx == null)
                {
                    s_emptyEx = new ProtectedString(true, Array.Empty<byte>());
                }
                return s_emptyEx;
            }
        }
